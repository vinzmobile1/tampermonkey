// ==UserScript==
// @name         Shopee All-in-One Scraper v9.1 (Keyword Filter)
// @namespace    https://shopee.co.id/
// @version      9.1
// @description  Menambahkan filter untuk "Target Keyword" yang tidak diinginkan dan semua fitur terbaru.
    ...
    function extractSearchItemData(rawItem) {
        ...
        if (rawItem.json_data) {
            ...
            if (decodedAdData) {
                ...
                if ([30,31,37,41].includes(bid_type_code) && decodedAdData['bid-infos']?.[0]) {
